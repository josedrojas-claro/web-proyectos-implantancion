...
import { deleteMaterialesAsignados } from "../../../services/materialesServices";
...
const ListaMaterialesPlanificados = ({
  ...
  const handleDeleteSelected = async () => {
    ...
    try {
      ...
      const response = await deleteMaterialesAsignados({
...
export default ListaMaterialesPlanificados;
